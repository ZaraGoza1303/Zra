...
export default function FriendCard({ user, onViewDetail }: Props) {
    return (
        <button onClick={onViewDetail} className="w-full flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/4 transition-colors text-left mb-0.5 group">
            <div className="relative">
                ...
                <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-emerald-500 rounded-full border-2 border-[#111318]" />
            </div>
